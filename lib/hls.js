...
function hlsSegment (input, segmentLength, startOffset) {
  ...
  let result = hlsSegmentSegmented(segments, startOffset);
  return result;

}

function hlsSegmentSegmented (segments, startOffset) {
...
function hlsSegmentPlaylist (input, segmentLength) {
  ...
  let template = hlsSegmentPlaylistSegmented(segmented);
  return template;
}

function hlsSegmentPlaylistSegmented (segmented) {
...
module.exports = { hlsSegment, hlsSegmentSegmented, hlsSegmentPlaylist, hlsSegmentPlaylistSegmented };
